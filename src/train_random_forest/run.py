...
def go(args):
    ...
    trainval_artifact = getattr(args, "trainval_artifact")
    logger.info(f"Training and validation data loaded from {trainval_artifact}")
    ...
    # YOUR CODE HERE
    ######################################
    X_train = X_train.astype({col: "string" for col in X_train.select_dtypes(include=["object"]).columns})
